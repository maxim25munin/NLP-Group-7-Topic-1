...
try:  # Optional dependency used for pretty confusion matrices
    import pandas as pd
except Exception as exc:  # pragma: no cover - optional dependency
    raise SystemExit("pandas is required to render pretty confusion matrices.") from exc
...
try:  # Optional dependency used for pretty confusion matrices
    ...
    raise SystemExit(
        "matplotlib and pretty_confusion_matrix are required to render pretty "
        "confusion matrices."
    ) from exc
