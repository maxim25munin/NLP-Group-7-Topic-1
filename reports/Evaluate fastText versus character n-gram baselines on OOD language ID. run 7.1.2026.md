...
```
    ...
    C:\Users\Maxim\AppData\Local\Temp\ipykernel_26428\2030961400.py:406: UserWarning: Ignoring unrecognised arguments: ['-f', 'C:\\Users\\Maxim\\AppData\\Roaming\\jupyter\\runtime\\kernel-7d4c2732-61f4-49ea-98e8-3a20a2f0251d.json']
      warnings.warn(f"Ignoring unrecognised arguments: {unknown_args}")
    ...
    fastText in-distribution accuracy: 0.9975
    Char n-gram in-distribution accuracy: 0.9940
    fastText + Char n-gram in-distribution accuracy: 0.9985
    fastText OOD (kazakh) accuracy: 0.9958 | macro F1: 0.4989
    Char n-gram OOD (kazakh) accuracy: 0.9999 | macro F1: 0.5000
    fastText + Char n-gram OOD (kazakh) accuracy: 0.9973 | macro F1: 0.4993
    fastText OOD (latvian) accuracy: 0.9835 | macro F1: 0.3306
    Char n-gram OOD (latvian) accuracy: 0.9764 | macro F1: 0.1976
    fastText + Char n-gram OOD (latvian) accuracy: 0.9855 | macro F1: 0.4963
    ...
    fastText OOD (swedish) accuracy: 1.0000 | macro F1: 1.0000
    Char n-gram OOD (swedish) accuracy: 0.9978 | macro F1: 0.4994
    fastText + Char n-gram OOD (swedish) accuracy: 1.0000 | macro F1: 1.0000
    ...
    fastText OOD (urdu) accuracy: 1.0000 | macro F1: 1.0000
    Char n-gram OOD (urdu) accuracy: 1.0000 | macro F1: 1.0000
    fastText + Char n-gram OOD (urdu) accuracy: 1.0000 | macro F1: 1.0000
    ...
    fastText OOD (yoruba) accuracy: 0.9996 | macro F1: 0.4999
    Char n-gram OOD (yoruba) accuracy: 0.9909 | macro F1: 0.3318
    fastText + Char n-gram OOD (yoruba) accuracy: 1.0000 | macro F1: 1.0000
    fastText macro OOD accuracy: 0.9859 | macro F1: 0.9656
    Char n-gram macro OOD accuracy: 0.9800 | macro F1: 0.9063
    fastText + Char n-gram macro OOD accuracy: 0.9877 | macro F1: 0.9695
    
    Summary:
                                     Model  Accuracy  Macro Precision  Macro Recall  Macro F1
        fastText + LogisticRegression (ID)  0.997500         0.997506      0.997500  0.997502
     Char n-gram + LogisticRegression (ID)  0.994000         0.994001      0.994000  0.993990
               fastText + Char n-gram (ID)  0.998500         0.998502      0.998500  0.998501
       fastText + LogisticRegression (OOD)  0.985879         0.944383      0.995770  0.965594
    Char n-gram + LogisticRegression (OOD)  0.979951         0.850442      0.993006  0.906254
              fastText + Char n-gram (OOD)  0.987669         0.949669      0.996564  0.969483
    Saved metrics visualization to reports\ood_fasttext_char_summary.png
