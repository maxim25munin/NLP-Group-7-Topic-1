...
```
    ...
    C:\Users\Maxim\AppData\Local\Temp\ipykernel_24400\2845087210.py:503: UserWarning: Ignoring unrecognised arguments: ['-f', 'C:\\Users\\Maxim\\AppData\\Roaming\\jupyter\\runtime\\kernel-aae900b1-254e-452f-a56b-2ba552eff683.json']
      warnings.warn(f"Ignoring unrecognised arguments: {unknown_args}")
    ...
    fastText OOD accuracy (kazakh): 0.9958
    fastText OOD accuracy (latvian): 0.9835
    ...
    fastText OOD accuracy (swedish): 1.0000
    ...
    fastText OOD accuracy (urdu): 1.0000
    fastText OOD accuracy (yoruba): 0.9996
    fastText macro OOD accuracy: 0.9859
 ...
 <tr style="text-align: left;">
  ...
  <tbody>
    ...
    Map:   0%|          | 0/132428 [00:00<?, ? examples/s]
    ...
    XLM-R in-distribution accuracy: 0.9950
    XLM-R macro OOD accuracy: 0.9431
    
    Summary:
                            Model  ID Accuracy  OOD Accuracy  Performance Drop
    fastText + LogisticRegression       0.9975      0.985879          0.011621
                XLM-R fine-tuning       0.9950      0.943063          0.051937
